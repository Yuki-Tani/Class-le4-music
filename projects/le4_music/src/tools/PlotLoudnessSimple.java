...
public class PlotLoudnessSimple extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// RMSに変換
		final double[] rmsLog = TransformTools.toRMSdB(wave, frameSize, shiftSize);
		
		// チャート作成
		String title = ChartTools.requestName("title", "loudness");
